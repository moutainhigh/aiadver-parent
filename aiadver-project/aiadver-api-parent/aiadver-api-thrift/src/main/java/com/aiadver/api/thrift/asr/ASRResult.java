...
public class ASRResult implements TBase<ASRResult, ASRResult._Fields>, Serializable, Cloneable, Comparable<ASRResult> {
    ...
    static {
        ...
        tmpMap.put(_Fields.RSLT_STATUS, new FieldMetaData("rsltStatus", TFieldRequirementType.DEFAULT,
        ...
        tmpMap.put(_Fields.IS_INTERRUPTED, new FieldMetaData("isInterrupted", TFieldRequirementType.DEFAULT,
                new FieldValueMetaData(TType.I32)));
